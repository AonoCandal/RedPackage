package com.aono.wavemodule.view;
...
import com.aono.wavemodule.R;
import com.aono.wavemodule.utils.DensityUtil;
...
//        Log.i(TAG,"onLayout");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mode.equals(MODE_DRAWABLE)){
            drawableToBitamp(mContext.getResources().getDrawable(R.drawable.wave_icon),canvas);
